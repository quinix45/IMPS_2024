...
<i class="fa fa-solid fa-thumbs-up" style="color: #9B3922;"></i> 2PL models with hierarchical priors perform reasonably well even when when $N = 100$ (k&ouml;nig et al., 2020).
...
The 6 IRT models (1PL, 2PL, 1CLL, 2CLL, 1NLL, 2NLL) will be estimated through MCMC using `brms` (B&uuml;rkner, 2017).
...
The models used the partial pooling approach (i.e., random intercepts/slopes)
