...
- **Item parameters:** characteristics an item itself ($i$).
...
::: {.fragment .fade-in fragment-index="1"}
- Is it possible to leverage simple symmetric and asymmetric IRT models (1PL, 2PL, 1CLL, 2CLL, 1NLL, 2NLL) to recover complex IRFs in **small sample sizes**?
:::
...
::: {.fragment .fade-in fragment-index="2"}  
- BMA's advantage over MS is more noticeable at low/high quantiles and with smaller sample sizes and less items.  
:::
...
::: {.fragment .fade-in fragment-index="4"}  
- Empirical quantiles seemed to offer sight improvements over theoretical quantiles.
:::
...
::: {.fragment .fade-in fragment-index="2"}  
<p style="font-size: 24px;"> Models are compared by summing these pointwise fit measures. What if we compared these fit measures also across ***items*** rather than just across models? </p>
:::
